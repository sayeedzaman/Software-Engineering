        ...
        while(true) {
            ...
            if(choice == 1) {
                if(abcServer.getCurrentState() != 1) {
                    System.out.println("operation failed, server not operational");
                    continue;
                }
                ...
                if(choice == 1) {
                    ...
                    name = scn.nextLine();
                    System.out.print("enter type(premium/regular): ");
                    type = scn.nextLine();
                    ...
                    if(detachedUsers.size() == 0) {
                        System.out.println("no previous user"+"\n");
                        continue;
                    }
                    ...
                    if(choice<1 || choice>detachedUsers.size()) {
                        System.out.println("invalid choice given, try again..."+"\n");
                    } else {
                ...
                if(choice == abcServer.getCurrentState()) {
                    System.out.println("same state chosen, try again..."+"\n");
                    continue;
                }
                ...
                if(choice==1 || choice==2 ||choice==3) {
                    ...
                    System.out.println("invalid state given, try again..."+"\n");
                }
